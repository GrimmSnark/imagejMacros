...
macro "EDoF T Series... " 
{
	  runMacro("EDoF_TSeries.ijm");
	  
}

// Prep Max Intensity

macro "Max Intensity T Series... " 
{
	  runMacro("prep_Max_Intensity.ijm");
	  
}

macro "Max Intensity T Series Motion... " 
{
...
macro "Max Intensity T Series Motion Batch... " 
{
	  runMacro("prep_Max_Intensity_Motion_Batch.ijm");
	  
}



macro "Crop Microglia Images... " 
{
	  runMacro("crop_MicrogliaImages.ijm");
